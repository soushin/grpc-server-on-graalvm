...
@javax.annotation.Generated(
    ...
    comments = "Source: app/echo.proto")
public final class EchoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<app.grpc.server.gen.echo.EchoMessage,
      app.grpc.server.gen.echo.EchoMessage> getEchoServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "EchoService",
      requestType = app.grpc.server.gen.echo.EchoMessage.class,
      responseType = app.grpc.server.gen.echo.EchoMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<app.grpc.server.gen.echo.EchoMessage,
      app.grpc.server.gen.echo.EchoMessage> getEchoServiceMethod() {
    io.grpc.MethodDescriptor<app.grpc.server.gen.echo.EchoMessage, app.grpc.server.gen.echo.EchoMessage> getEchoServiceMethod;
    if ((getEchoServiceMethod = EchoServiceGrpc.getEchoServiceMethod) == null) {
      synchronized (EchoServiceGrpc.class) {
        if ((getEchoServiceMethod = EchoServiceGrpc.getEchoServiceMethod) == null) {
          EchoServiceGrpc.getEchoServiceMethod = getEchoServiceMethod = 
  ...
  public static abstract class EchoServiceImplBase implements io.grpc.BindableService {
    ...
    public void echoService(app.grpc.server.gen.echo.EchoMessage request,
      ...
      asyncUnimplementedUnaryCall(getEchoServiceMethod(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getEchoServiceMethod(),
            asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class EchoServiceStub extends io.grpc.stub.AbstractStub<EchoServiceStub> {
    ...
    public void echoService(app.grpc.server.gen.echo.EchoMessage request,
        io.grpc.stub.StreamObserver<app.grpc.server.gen.echo.EchoMessage> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getEchoServiceMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class EchoServiceBlockingStub extends io.grpc.stub.AbstractStub<EchoServiceBlockingStub> {
    ...
    public app.grpc.server.gen.echo.EchoMessage echoService(app.grpc.server.gen.echo.EchoMessage request) {
      return blockingUnaryCall(
          getChannel(), getEchoServiceMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class EchoServiceFutureStub extends io.grpc.stub.AbstractStub<EchoServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<app.grpc.server.gen.echo.EchoMessage> echoService(
      ...
      return futureUnaryCall(
          getChannel().newCall(getEchoServiceMethod(), getCallOptions()), request);
    }
  }
      ...
      synchronized (EchoServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getEchoServiceMethod())
              .build();
        }
      }
    }
